...
color cast_ray(ray r, sphere spheres[], int num_spheres, color color, light light,  point point);                      
void cast_all_rays(double min_x, double max_x, double min_y, double max_y, int width, int height,point eye, sphere spheres[], int num_spheres, color color, light light);  
#endif 