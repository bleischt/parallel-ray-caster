...
#pragma offload target(mic) in(eye, light, color, num_spheres, height, width, pixels_in_x, pixels_in_y, min_x, min_y) nocopy(spheres) out(printSpheres:length(width*height*3))
{ 
